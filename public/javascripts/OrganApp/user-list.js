...
$.getJSON(`/OrganApi/user-list`, data => {
    console.log(data)
    wishes = data
    makeTable(data)
    ...
    <div class="col">
      <div class="card bg-default shadow">
        <div class="card-header bg-transparent border-0">
          <h3 class="text-white mb-0">All User List</h3>
...
function refresh() 
{
    $.getJSON(`/OrganApi/user-list`, data => makeTable(data))
}
...
$('#result').on('click', '.delete', function() {
  ...
  $.post('/OrganApi/user-list-delete',{id},data=>{
